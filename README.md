# Library
[An intermediate JS project for the Odin Project.](https://www.theodinproject.com/lessons/node-path-javascript-library)
...
> 6. To facilitate this you will want to create Book prototype function that toggles a book instance’s read status.
